# nvim-treesitter-queries-gitignore

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gitignore/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gitignore/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gitignore**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gitignore",
...
- [ ] Changes are scoped to `gitignore` — do not include files for other languages
